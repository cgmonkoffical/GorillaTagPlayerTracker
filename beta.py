...
def Tracker_Started(user):
    ...
    payload = {
        ...
        "embeds": [{
            ...
            While tracking you may find **Finger painter, Hightech Slingshot, Stick, Admin Badge, Unreleased Sweater** and **Illustrator badge**",
            "color": 0x00FFFFFF,
            "footer": {
...
if {item} == "FINGER PAINTER":
    ppayload = {
        ...
        "embeds": [{
            ...
            "description":
            f"**ITEM: Finger Painter** 
            ROOM: **{room}**
            TIME: **{current_time}**
            REGION:  **{region}** 
            -#ⓘ **NOTE** These players can not ban you but they are in contact with **moderators**.",
            "color": 0x00FF00,
    ...
    payload = {
        ...
        "embeds": [{
            ...
            "description":
            f"**ITEM: Hightech Slingshot** 
            ROOM: **{room}** 
            TIME: **{current_time}** 
            REGION: **{region}**
            -#ⓘ This is one of the rarest cosmetics.",
            "color": 0x00FF00,
            "footer": {
                "text": "Log generated at"
            },
    ...
    ppayload = {
        ...
        "embeds": [{
            ...
            TIME: **{current_time}** 
            REGION: **{region}**
            -#ⓘ**NOTE** This person can and will **ban** you for tracking.",
            "color": 0x00FF00,
            "footer": {
                "text": "Log generated at"
            },
    ...
    ppayload = {
        ...
        "embeds": [{
            ...
            "description":
            f"**ITEM: Unreleased Sweater** 
            ROOM: **{room}** 
            TIME: **{current_time}** 
            REGION: **{region}**
            -#ⓘ This person is a modder who obtained the unreleased sweater.",
            "color": 0x00FF00,
            "footer": {
                "text": "Log generated at"
            },
